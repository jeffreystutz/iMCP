...
| [0012](0012-split-messages-send-tools.md) | Accepted | Restore two public Messages send tools, `message_send_text` and `message_send_attachment`, one per Messages submission class; restores pre-consolidation missing-body elicitation; ADR 0009's and ADR 0010's contracts carried forward unchanged. |
