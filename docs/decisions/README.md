...
| [0010](0010-global-automatic-send-authorization-policy.md) | Proposed | Persist one global, category-keyed automatic-send authorization policy, app-owned and unreachable by any MCP caller, in place of a per-client model the current connection stack cannot securely support. |
